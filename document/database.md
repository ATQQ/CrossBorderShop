...
* settings 小程序相关的一些配置字段

|    字段    |     说明     |     类型     |   默认   |     描述     |          举例          |
| :--------: | :----------: | :----------: | :------: | :----------: | :--------------------: |
|     id     |     主键     |     int      | NN,PK,UQ |  主键,自增   |         0,1,2          |
| goodstype  |   商品分类   | varchar(256) |   NULL   |   商品分类   |  ["电子产品","服饰"]   |
| homeadvice | 首页推荐分类 | varchar(12)  |   NULL   | 首页推荐分类 | ["评价","销量","好评"] |
|  swipers   |    轮循图    | varchar(256) |   NULL   |  首页轮播图  |       imagesUrl        |
